...
namespace Config {
	...
	enum Key {
		...
		NPCS_LUA_DIRECTORY,
		CANARY_CRYSTAL_ASSETS_DIRECTORY,
		THEME,
		ACTIVE_THEME,
		SPAWN_CONVERTER_DIRECTORY,
		MAP_ITEM_ID_CONVERTER_MEMORY_LIMIT_GIB,
		SHOW_AUTOBORDER_PREVIEW,
		INGAME_PREVIEW_VISIBLE,
		INGAME_PREVIEW_LAYOUT,
		POST_PROCESS_EFFECT,
		ENABLE_DIAGNOSTIC_LOG,
		WORKSPACE_CLIENT_ROOT,
		WORKSPACE_SERVER_ROOT,
		WORKSPACE_ITEMS_OTB_PATH,
		WORKSPACE_ITEMS_XML_PATH,
		WORKSPACE_APPEARANCES_PATH,
		WORKSPACE_ITEM_ID_MODE,
		DRAGON_SOULS_OTBM_COUNT_UINT16,
		USE_CPU_GEOMETRY_CACHE,
		USE_GPU_GROUND_CACHE,
		MINIMAP_SHOW_COMPASS,
		MINIMAP_SHOW_CONTROLS,
		MINIMAP_ZOOM_LEVEL,
